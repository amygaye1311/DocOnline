    ...
    <div className="group bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="space-y-3 pt-4 border-t border-slate-50">
        <div className="flex justify-between text-sm">
          ...
          <span className="font-semibold text-slate-700">{pharmacy.distance} km</span>
        </div>
      </div>
      ...
      <div className="mt-6 flex gap-2">
        <a 
          ...
          className="flex-1 bg-emerald-50 text-emerald-700 text-center py-2.5 rounded-xl font-bold text-sm hover:bg-emerald-600 hover:text-white transition-all"
        >
          📞 Appeler
        </a>
        <button 
